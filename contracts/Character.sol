...
contract Character is ERC721Enumerable, PaymentSplitter, Ownable, ReentrancyGuard {
    ...
    constructor(string memory _theBaseURI, string memory _notRevealedURI, bytes32 _merkleRoot) ERC721("CHARACTER", "NFTSymbol") PaymentSplitter(_team, _teamShares) {
